                        ...
                        <form method="POST"  action="{{ route('password.update') }}">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <a class="btn btn-back-page" href="{{ route('logout') }}">
                                    ...
                                    <div class="form-group">
                                        <label for="new-password" class="form-label">{{ __('Password') }}</label>
                                        <input type="password" class="form-control {{ $errors->has('password') ? ' is-invalid' : '' }}" id="new-password"
                                            value="" name="password" placeholder="Enter new password" required>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="password" class="form-control" id="confirm-password"
                                            value="" placeholder="Confirm new password" required name="password_confirmation">
                                        
                                    </div>

                                    <div class="row">
                                        <div class="col-12">
                                            <button type="submit" class="btn btn-primary">{{ __('Reset Password') }}</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
