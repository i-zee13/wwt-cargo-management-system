...
<div class="row">
    <div class="col col-xsm-w pr-0">
        <div class="search">
            ...
            <input class="form-control" id="customSearchInput" type="text" placeholder="{{__('fields.search_origin_here')}}">
        </div>
    </div>
    <div class="col-auto col-xsm-w">
        <a href="/admin/create-origin"   class="btn btn-primary   mt-0  " >+ {{__('fields.new_origin')}}</a>
...
<div class="row">
    <div class="col-md-12">
        <div class="card">
            ...
            <div class="card-body origins_body p-0" style="display: none">
            </div>
        </div>
    </div>
</div>
...
@push('js')
<script>
    $('.content_head').text('{{__('fields.origins_management')}}') 
</script>
