...
<div class="row">
    <div class="col col-xsm-w pr-0">
        <div class="search">
            ...
            <input class="form-control" id="customSearchInput" type="text" placeholder="Search Customers Here...">
        </div>
    </div>
    <div class="col-auto col-xsm-w">
        <a href="/create-customer" class="btn btn-primary mt-0">+ New Customer</a>
...
<div class="row">
    <div class="col-md-12">
        <div class="card">
            ...
            <div class="card-body customers_table_body p-0" style="display: none">
            </div>
        </div>
    </div>
</div>
...
@push('js')
<script>
    $('.content_head').text('Customers Management');
</script>
