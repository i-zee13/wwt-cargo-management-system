...
return [
    ...
    */
    'custom' => [
        ...
        'email.same' => 'El correo electrónico y la confirmación deben coincidir.',
        'confirm_email.required' => 'La confirmación del correo electrónico es obligatoria.',
    ...
    'email' => [
        ...
        'same' => 'El correo electrónico y la confirmación deben coincidir.',
    ],
    'password' => [
        'same' => 'La contraseña y la confirmación de la contraseña deben coincidir.',
    ],
    'document_type' => [
        'exists' => 'El tipo de documento seleccionado no es válido.',
    ],
    'branch' => [
