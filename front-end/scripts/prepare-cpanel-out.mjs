...
writeFileSync(
  ...
  [
    ...
    "RewriteEngine On",
    "# Customer auth lives on portal — never serve these paths from the marketing site",
    "RewriteRule ^customer-login/?$ https://portal.wwt.com.py/customer-login [R=302,L]",
    "RewriteRule ^customer-register/?$ https://portal.wwt.com.py/customer-register [R=302,L]",
    "RewriteRule ^customer-mylogin/?$ https://portal.wwt.com.py/customer-mylogin [R=302,L]",
